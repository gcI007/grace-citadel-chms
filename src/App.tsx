...
export default function App() {
  ...
  const [trackingMidweekHistory, setTrackingMidweekHistory] = useState<any[]>([]); // NEW: Cell Log History State
  ...
  const handleSelectTrackingMember = async (member: any) => {
      ...
      // 2. Fetch Mid-Week Cell Meeting Attendance (Matches by Leader Name or Cell Name)
  ...
  return (
    <div className="min-h-screen bg-[#EBE7DD] flex flex-col font-inter">
      ...
      <main className="flex-1 p-6 relative">
        ...
        {/* --- 🔥 UPDATED: MEMBER HISTORY COMPONENT WITH DUAL LOGGING 🔥 --- */}
